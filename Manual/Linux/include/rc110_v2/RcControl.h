...
//			713, 512, 418, 341, 279, 251, 229, 204, 186, 170, 155, 145, 139, 130, 124,
			772, 512, 416, 346, 284, 247, 216, 192, 172, 158, 148, 132, 120, 108, 100,
	};
	...
	const static ushort thermo_adc[16] = {
		756, 662, 561, 512, 464, 375, 299, 236, 186, 146, 130, 115, 92, 73, 59, 53,
	};

	const static ushort thermo_values[16] = {
		0, 10, 20, 25, 30, 40, 50, 60, 70, 80, 85, 90, 100, 110, 120, 125,
	};
...
public:
	...
	bool GetThermoInfoReq(THERMO_VALUE* value);
	...
	float ThermoAdcToTemp(unsigned short value);
